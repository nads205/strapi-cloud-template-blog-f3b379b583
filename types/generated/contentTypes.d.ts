...
export interface ApiProgramSessionProgramSession
  extends Struct.CollectionTypeSchema {
  collectionName: 'program_sessions';
  info: {
    displayName: 'Program Session';
    pluralName: 'program-sessions';
    singularName: 'program-session';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::program-session.program-session'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiStudentApplicationStudentApplication
  extends Struct.CollectionTypeSchema {
